 ...
 * @version V1.0
 */
class WxArticleListPresenter:WxArticleListContract.Presenter {
    private var mView:WxArticleListContract.View ?= null

    override fun getWxArticle(page: Int, id: Int) {
        val client = HttpClient.Builder()
            .baseUrl(Apis.WX_ARTICLE_LIST)
            .url(id.toString()+"/"+page.toString()+"/json")
    ...
    override fun attachView(view: IView) {
        mView = view as WxArticleListContract.View
    }
